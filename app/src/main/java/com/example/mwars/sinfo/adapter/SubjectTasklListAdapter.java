...
//        Log.d("_HOLDER_ID_", String.valueOf(holder.getItemId()));
    ...
    public class SubjectDetailHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageView IMG_FAV, IMG_EDIT, IMG_SHARE;
        ...
        public SubjectDetailHolder(View itemView) {
            ...
            IMG_SHARE = (ImageView) itemView.findViewById(R.id.img_share_task);
        ...
        public void onClick(View view) {
            ...
            } else if (view.getId() == R.id.img_share_task) {
                _itemClickCallback.onShareTaskClick(getAdapterPosition());
            }
        }
    }
